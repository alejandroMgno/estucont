...
function PegaBlancoPremium({ setCurrentPage }) {
  return (
    <section className="bg-white text-gray-800 py-16 px-4 sm:py-20">
      ...
      >
        ...
        >
          Adhesivo de alto rendimiento para porcelanatos y cerámicos de gran
          formato. Pasta blanca fina, ideal para interiores, muros y pisos de
          baja absorción.
        </motion.p>
        ...
        {[
          ...
          },
          {
            ...
            items: [
              ...
              "Evitar tránsito intenso por al menos 24 horas..",
            ],
          },
        ].map((section, idx) => (
          <motion.div
...
export default PegaBlancoPremium;
