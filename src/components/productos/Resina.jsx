    ...
    <section className="bg-white text-gray-800 py-16 px-4 sm:py-20">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-center mb-10">
          Producto de alto rendimiento para sellado y protección en interiores y exteriores. Fórmula transparente o blanca, ideal para pisos, muros y superficies de baja absorción.
        </p>
        ...
        <div className="mb-10">
          ...
          <ul className="list-disc list-inside text-base text-gray-700 space-y-2">
            <li>Presentación: saco de 20 kg</li>
            <li>Color: blanco</li>
            <li>
