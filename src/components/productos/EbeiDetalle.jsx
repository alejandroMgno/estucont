...
function EstucoBlancoExterioreInterior
({ setCurrentPage }) {
  return (
    <section className="bg-white text-gray-800 py-16 px-4 sm:py-20">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-4xl font-bold mb-6 text-center text-lime-600">
          Estuco Blanco Exterior e Interior

        </h2>
        <p className="text-lg text-center mb-10">
          Revestimiento de alta calidad en pasta blanca fina, especialmente diseñado para acabados en muros y pisos tanto interiores como exteriores. 
          Ideal para superficies de baja absorción, ofrece un acabado liso, resistente y de excelente adherencia, proporcionando protección y estética duradera.
        </p>
...
export default EstucoBlancoExterioreInterior
;
